...
const config: Config = {
  ...
  routes: [
    ...
    { path: "/oracle", description: "Trust oracle -- query EigenTrust-derived scores for any wallet or agent address" },
    ...
    { path: "/docs/trust-scoring", description: "Trust scoring model -- wallet and token scoring via EigenTrust on Intuition data" },
