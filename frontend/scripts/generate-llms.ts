...
const config: Config = {
  ...
  baseUrl: "https://www.trustgated.xyz",
  routes: [
    ...
    { path: "/staking", description: "Stake USDC for or against any subject -- X, LinkedIn, GitHub, Discord, Telegram, token, wallet, website, or URI" },
    { path: "/swaparc", description: "Live on Swaparc -- confirm TrustGate VERIFIED and scored-token badges on the DEX token search" },
